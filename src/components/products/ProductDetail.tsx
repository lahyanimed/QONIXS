    ...
    <div className="max-w-7xl mx-auto px-4 py-6">
      ...
      <div className="flex flex-col lg:flex-row gap-10 mb-12">
        ...
        <div className="flex-1 lg:max-w-md">
          ...
          {/* WhatsApp CTA */}
          <a
            href={`https://wa.me/212660248290?text=Bonjour%2C%20je%20suis%20int%C3%A9ress%C3%A9%20par%20le%20produit%20${encodeURIComponent(product.name)}%20sur%20Qonixs.com`}
            target="_blank"
            rel="noopener noreferrer"
            className="mt-3 flex items-center justify-center gap-2 w-full py-2.5 rounded-xl bg-green-500 text-white font-dm font-medium text-sm hover:bg-green-600 transition-colors"
          >
